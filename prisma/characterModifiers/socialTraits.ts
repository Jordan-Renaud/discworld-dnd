  ...
  Promise.all([
    ...
    prisma.socialTrait.create({
      data: {
        name: "Vocal Features",
        description:
          "You may have a notably good or bad voice. This modifies reaction rolls when you have to talk to people, and it affects the skills Diplomacy, Fast-Talk, Mimicry, Performance, Politics, Public Speaking, Sex Appeal, and Singing.",
        basePointsCost: 0,
        categories: {
          createMany: {
            data: [
